...
final class File
{
    ...
    {
        self::encryptFileInternal($inputFilename, $outputFilename, KeyOrPassword::createFromPassword($password));
    }
    /**
    ...
    private static function encryptFileInternal($inputFilename, $outputFilename, KeyOrPassword $secret)
    {
        ...
        if ($if === \false) {
            throw new Ex\IOException('Cannot open input file for encrypting: ' . self::getLastErrorMessage());
        }
        ...
        if ($of === \false) {
            \fclose($if);
            throw new Ex\IOException('Cannot open output file for encrypting: ' . self::getLastErrorMessage());
        }
        ...
        if (\fclose($if) === \false) {
            \fclose($of);
            throw new Ex\IOException('Cannot close input file after encrypting');
        }
        /* Close the output file. */
        if (\fclose($of) === \false) {
            throw new Ex\IOException('Cannot close output file after encrypting');
        }
    }
    /**
