...
use Matomo\Dependencies\OAuth2\Defuse\Crypto\Crypto;
use Matomo\Dependencies\OAuth2\Defuse\Crypto\Exception\EnvironmentIsBrokenException;
use Matomo\Dependencies\OAuth2\Defuse\Crypto\Exception\WrongKeyOrModifiedCiphertextException;
...
trait CryptTrait
{
    ...
    protected function decrypt(string $encryptedData) : string
    {
        try {
            ...
            $exceptionMessage = 'The authcode or decryption key/password used ' . 'is not correct';
            throw new InvalidArgumentException($exceptionMessage, 0, $e);
        } catch (EnvironmentIsBrokenException $e) {
            $exceptionMessage = 'Auth code decryption failed. This is likely ' . 'due to an environment issue or runtime bug in the ' . 'decryption library';
