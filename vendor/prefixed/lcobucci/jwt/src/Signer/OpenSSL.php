...
abstract class OpenSSL implements Signer
{
    ...
    /** @throws InvalidKeyProvided */
    protected final function verifySignature(string $expected, string $payload, string $pem) : bool
    {
    ...
    /** @throws InvalidKeyProvided */
    protected abstract function guardAgainstIncompatibleKey(int $type, int $lengthInBits) : void;
    /**
     * Returns which algorithm to be used to create/verify the signature (using OpenSSL constants)
     *
     * @internal
     */
    public abstract function algorithm() : int;
}
