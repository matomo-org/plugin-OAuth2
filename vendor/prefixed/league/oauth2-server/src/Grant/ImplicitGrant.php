...
class ImplicitGrant extends AbstractAuthorizeGrant
{
    ...
    public function validateAuthorizationRequest(ServerRequestInterface $request) : AuthorizationRequestInterface
    {
        ...
        $scopes = $this->validateScopes($this->getQueryStringParameter('scope', $request, $this->defaultScope), $this->makeRedirectUri($redirectUri ?? $this->getClientRedirectUri($client), $stateParameter !== null ? ['state' => $stateParameter] : [], $this->queryDelimiter));
    ...
    public function completeAuthorizationRequest(AuthorizationRequestInterface $authorizationRequest) : ResponseTypeInterface
    {
        ...
        if ($authorizationRequest->isAuthorizationApproved() === \true) {
            ...
            $response->setRedirectUri($this->makeRedirectUri($finalRedirectUri, ['access_token' => $accessToken->toString(), 'token_type' => 'Bearer', 'expires_in' => $accessToken->getExpiryDateTime()->getTimestamp() - time(), 'state' => $authorizationRequest->getState()], $this->queryDelimiter));
            return $response;
        }
